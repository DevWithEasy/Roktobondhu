...
const DeleteContributer = ({ id,open, setOpen }) => {
    const {deleteContributers,isLoading,activeLoading,cancelLoading } = useUserStore()
    const handleDelete = async() => {
        activeLoading()
        try {
            const res = await axios.delete(`${apiUrl}/api/contributer/${id}`,{
                headers: {
                    'authorization': token()
                }
            })
...
export default DeleteContributer;